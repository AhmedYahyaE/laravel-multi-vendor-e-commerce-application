...
return new class extends Migration
{
    ...
    public function down()
    {
        ...
        Schema::table('banners', function($table) {
            $table->dropColumn('type'); // Reverse the up() method procedure, and in this case, the up() method adds a column, so here in down() method, we reverse the operation, so we delete (drop) the column
        });
    }
};
