...
class APIController extends Controller
{
    ...
    public function pushOrder($id) { // This route/URL/link is: http://127.0.0.1:8000/api/push-order/3    // Route Parameters: Required Parameters: https://laravel.com/docs/9.x/routing#required-parameters
